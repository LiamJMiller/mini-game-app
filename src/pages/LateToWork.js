...
window.onload = startGame; // Call the startGame function when the window loads

const PLAYER_JUMP_FORCE = 400;
const PLAYER_START_POSITION_RATIO = 0.25; // Ratio to game height
const MAX_CONSECUTIVE_JUMPS = 3;
const INITIAL_SCORE = 0;
const PLATFORM_HEIGHT_RATIO = 0.8; // Ratio to game height
const SMALL_SCREEN_SPAWN_RANGE = [50, 150];
const LARGE_SCREEN_SPAWN_RANGE = [100, 350];
const GAME_BACKGROUND_COLOR = 0x444444;

// Global game options
let gameOptions = {
  platformStartSpeed: 350, // Initial speed of the platforms
  spawnRange: [100, 350], // Range of possible distances between platforms
  platformSizeRange: [50, 250], // Range of possible platform widths
  playerGravity: 900, // Gravity applied to the player
  jumpForce: 400, // Force applied when the player jumps
  playerStartPosition: 200, // Initial x position of the player
  jumps: 3, // Number of consecutive jumps the player can make
  score: 0, // Initial score
  scoreTimer: null, // Timer for increasing the score
  backgroundSpeed: 1, // Adjust this value to change the speed of the background
  primaryTextColor: "#fff", // White
  secondaryTextColor: "#569cd6", // Blue
  tertiaryTextColor: "#d6565c", // Red
  quaternaryTextColor: "#d69056", // Orange
};
...
class playGame extends Phaser.Scene {
  ...
  // Method to spawn a bean on a platform
